...
El .zip entregado ha de contener:
	...
	 YoutubeDownloaderApp.xml: archivo con la configuración de la aplicación en
	IcegridGUI.
	 README.md: contendrá el enlace al repositorio, los nombres de los alumnos que componen
	el grupo y el manual de usuario con la especificación de cómo lanzar el sistema.
